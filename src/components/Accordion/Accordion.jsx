function Accordion() {
    return(
        ...
        <div className="col-sm-6 px-5">
          <h1 className="text-24-bold ps-5">Frequently Asked Question</h1>
          <p className="text-16-light ps-5">
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  <strong>Shopeymart</strong> t adalah platform penjualan online yang menyediakan berbagai produk kebutuhan sehari-hari, termasuk pakaian, elektronik, kebutuhan rumah tangga,
